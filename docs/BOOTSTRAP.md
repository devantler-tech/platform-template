...
Bootstrap validates the heartbeat URL and derives its DNS hostname into the same
encrypted cluster Secret for the Coroot network policy; no separate hostname
secret or input is required.
